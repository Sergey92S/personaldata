...
<div class="container" style="width: 600px;">
    <c:url var="editPage" value="/admin/edit"/>
    <s:form action="${editPage}" modelAttribute="person" method="post" class="form-horizontal" role="form">
        <input type="hidden" name="personLogin" value="${person.getLogin()}" />
        ...
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <select id="position" class="form-control" path="position" name="position" path="position">
                        <c:forEach items="${positions}" var="position">
                            <c:choose>
                                <c:when test="${position eq person.getPosition()}">
